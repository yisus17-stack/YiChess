      ...
      <div className="max-w-[1200px] w-full mx-auto px-10 py-20">
        <div className="bg-primary rounded-3xl p-16 text-center flex flex-col items-center gap-10 shadow-2xl relative overflow-hidden">
          <div className="absolute -right-10 -bottom-10 opacity-10">
            <svg className="text-primary-foreground size-[300px]" fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
              <path
                clipRule="evenodd"
          ...
          <h1 className="text-2xl md:text-5xl font-bold text-primary-foreground tracking-tight z-10">
            Comienza con YiChess Hoy Mismo
          </h1>
          <p className="text-primary-foreground/80 text-base font-light max-w-2xl z-10 leading-relaxed">
