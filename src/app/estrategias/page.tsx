...
const strategies = [
    {
      name: 'Aperturas',
      description: 'Explora las aperturas más comunes y sus variantes para empezar tus partidas con ventaja.',
    ...
    {
      name: 'Enroque',
      description: 'Un movimiento especial para proteger a tu rey y activar tu torre. Es fundamental.',
      icon: <Castle className="size-10 text-primary" />,
      href: '#'
    },
    {
      name: 'Jaque Mate',
      description: 'El objetivo final del ajedrez. Aprende diferentes patrones de jaque mate.',
